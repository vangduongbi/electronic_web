...
<div class="top"><!-- The top -->
      ...
      <div id="cart_expand" class="cart"> 
            <a href="<?php echo base_url('cart/index') ?>" class="cart_link">
               Giỏ hàng <span id="in_cart"><?php if(isset($total_items)) echo $total_items?></span> sản phẩm
            </a> 
       ...
       <div id="search"><!-- the search -->
			<form method="get" action="<?php echo base_url('product/search')?>">
			     				 <input type="text" id="text-search" name="key-search" value="<?php if(isset($key)){ echo $key;} else {echo ''; } ?>" placeholder="Tìm kiếm sản phẩm..." class="ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
    ...
    <div class="clear"></div><!-- clear float --> 
           ...
           <ul class="menu_top">
                ...
                <li class=""><a href="#"><?php echo 'Xin chào: '.$user_info->name; ?></a></li>
                <li class=""><a href="<?php echo base_url('user/logout')?>">Logout</a></li>
                <?php else : ?>
