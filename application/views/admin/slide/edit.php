...
<div class="wrapper">
	   	...
	   	<!-- Form -->
		<form enctype="multipart/form-data" method="post" action="<?php echo admin_url('slide/edit/'.$slide->id)?>" id="form" class="form">
			<fieldset>
				<div class="widget">
				    <div class="title">
					         ...
					         <div class="formRow">
										...
										<div class="formRow">
											<label for="param_title" class="formLeft">Mô tả:<span class="req">*</span></label>
												<div class="formRight">
													<span class="oneTwo"><input type="text" _autocheck="true" id="param_info" name="info" value="<?php echo $slide->info;?>"></span>
